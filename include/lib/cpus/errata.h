...
#define ERRATUM_ENTRY_SIZE_UNA	ERRATUM_MITIGATED + ERRATUM_MITIGATED_SIZE

#if CPU_WORD_SIZE == 16
#define	ERRATUM_ENTRY_SIZE	ERRATUM_ENTRY_SIZE_UNA + 8
#else
#define	ERRATUM_ENTRY_SIZE	ERRATUM_ENTRY_SIZE_UNA
#endif
